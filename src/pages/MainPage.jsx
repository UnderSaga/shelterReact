                ...
                <div className="container">
                    ...
                    <div className="slider">
                        ...
                        <div className="slider__cards">
                            <div className="slider__card" id="slider-katrine">
                            <img src={katrine} alt="Кэтрин" />
                            <h4 className="card__title">Katrine</h4>
                            <button className="button button_secondary">Learn more</button>
                            </div>
                            <div className="slider__card" id="slider-jennifer">
                            <img src={jennifer} alt="Дженифер" />
                            <h4 className="card__title">Jennifer</h4>
                            <button className="button button_secondary">Learn more</button>
                            </div>
                            <div className="slider__card" id="slider-woody">
                            <img src={woody} alt="Вуди" />
